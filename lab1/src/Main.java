...
//            conjMinimizer.next();
//        }
//        var fastestMinimizer = new FastestDescent(f, new Vector(0, 0), 1e-2, 2 / (minEigen + maxEigen));
//        for (int i = 0; i < 1000000 && fastestMinimizer.hasNext(); i++) {
//            var x = fastestMinimizer.getCurrentXMin();
//            System.out.printf("%d-th iteration: x={%.4f,%.4f}, f(x)=%.4f",
//                    i, x.getIth(0), x.getIth(1), fastestMinimizer.getFun().get(x));
//            System.out.println();
//            fastestMinimizer.next();
//        }
    }
